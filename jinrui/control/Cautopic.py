...
# #     cp.draw_pic(a, r'D:\teamsystem\jinrui-test\img\doc\2020\10\30\LMbKgJKutaAb5pZtpACz.png')
    ...
    def analysis_word(self, doc_path):
        # todo 配置解析exe
        # imgkit.from_file(r'C:\Users\shuai\Desktop\test_html\aRvomP5UMRiFzNZLEnX6.html', output_path=r'D:\\out.png', config=config_img)
        # imgkit.from_string(html_string, r'D:\\outo.png', config=config_img)
        # imgkit.from_string(, r'D:\\outo.png', config=config_img)
        # pdfkit.from_string(body, r'D:\\out.pdf', configuration=config)
        # html_path = r'C:\Users\shuai\Desktop\test_html'
        ...
        # print(html_name)
        # print(os.path.isfile(html_name))
        ...
        # ''.join([str(i) for i in paper_dict.get(paper) for paper in paper_dict])
        paper_dict_copy = {}
